...
func update(game: Game):
	...
	await create("Honks", str(game.honks), true, false)
	await create("Houses Bothered", str(game.houses_startled), false, false)
	await create("People Hurt", str(game.tourists_hit), true, false)
