...
@onready var world_menu: MeshInstance3D = %WorldMenu
...
func _mouse_input_event(_camera: Camera3D, event: InputEvent, event_position: Vector3, _normal: Vector3, _shape_idx: int) -> void:
	...
	var quad_mesh_size: Vector2 = world_menu.mesh.size
	...
	event_pos3D = world_menu.global_transform.affine_inverse() * event_pos3D
